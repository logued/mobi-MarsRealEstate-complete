...
// Use a binding adapter to take the URL from an XML attribute associated
// with an ImageView, and you use Glide to load the image.
// Binding adapters are extension methods that sit between a view and bound data
// to provide custom behavior when the data changes.
